...
Decepticon::Decepticon(const std::string &name, int level, int strength, int range, int fuel, int ammo, Weapon* weapon, const Shield &shield, const std::string &faction)
